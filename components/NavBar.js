  ...
  const DesktopNav = () => {
    return (
      <div className="h-[100px] bg-slate-100 relative flex w-[100vw] text-primary-green z-50 drop-shadow-lg justify-between ">
        ...
        <ul className="flex w-full items-center gap-6 justify-end mr-6 text-lg">
          <li className="p-2 border-2 rounded-xl border-primary-green">
            <Link href="/Home">Home</Link>
          </li>
          <li className="p-2 border-2 rounded-xl border-primary-green">
            <Link href="/Counselors">Counselors</Link>
          </li>
          <li className="p-2 border-2 rounded-xl border-primary-green">Services</li>
          <li className="p-2 border-2 rounded-xl border-primary-green">Booking</li>
          <li className="p-2 border-2 rounded-xl border-primary-green">Blog</li>
          <li className="p-2 border-2 rounded-xl border-primary-green">
            <Link href="/About">About</Link>
          </li>
          <li className="p-2 border-2 rounded-xl border-primary-green">FAQ</li>
          <li className="p-2 border-2 rounded-xl border-primary-green">
            Contact
          </li>
          <li className="px-6 font-bold text-primary-green text-2xl border-4 border-primary-green rounded-xl py-4 hover:bg-primary-green hover:text-slate-100 transition-all duration-200">
            <Link href="/SignUp">Sign Up</Link>
          </li>
        </ul>
      </div>
