      ...
      <div className="flex-col items-center px-4 bg-primary-green md:flex text-slate-100">
            ...
            <div className="md:w-[35%] md:flex flex-col items-center">
              ...
              <div className="my-4 text-lg">
                <span className="font-bold">
                  I have a background in the mental health field
                </span>{" "}
                and obtained a undergraduate degree in Psychology at Florida
                Gulf Coast University. Then, I trained as a{" "}
                <span className="font-bold">
                  Clinical Mental Health counselor
                </span>{" "}
                for a year, also at FGCU. Soon after, I pivoted to another
                program that allowed me to create{" "}
                <span className="font-bold">Mental health & You</span>.
              </div>
              <div className="mb-4 text-lg">
                <span className="font-bold">I understand what it is like</span>{" "}
                to suffer from trauma, grief, and depression, which is why I,
                and my team, are <span className="font-bold">passionate</span>{" "}
                about helping people through struggles like these. After seeing
                17 different counselors and dealing with these feelings,
                <span className="font-bold">
                  I was inspired to create a more effective solution
                </span>
                .
              </div>
              <div className="pb-4 text-lg">
                From my experience at FGCU,{" "}
                <span className="font-bold">
                  I developed knowledge that helped me understand trauma, grief,
                  and depression.
                </span>{" "}
                Through this process, I learned how to utilize my knowledge and
                resources given to me and wanted to{" "}
                <span className="font-bold">take it to the next step</span>
        ...
        <div className="items-center pt-10 md:flex justify-evenly">
          <div className="md:max-w-[30%] mx-10">
            <div className="my-4 text-lg">
              ...
              , we strive to use our expertise in order to create a comfortable
              and safe environment for you
            </div>
            <div className="mb-4 text-lg">
              Counseling services{" "}
              <span className="font-bold">
                have helped countless people get through stressful challenges
              </span>
              by questioning negative throughts and understanding the source of
              specific behaviors and emotional patterns.
            </div>
            <div className="pb-4 text-lg">
              With the right tools and a better approach to situations, we{" "}
              <span className="font-bold">guarentee </span>a better outlook on
              any issue that life brings your way.
            </div>
          </div>
        ...
        <div className="justify-center w-full pt-10 md:flex">
          ...
          <div className="md:w-[50%] flex flex-col">
            <h1 className="text-4xl md:mr-[20%] text-center">
              Starting Prices
            </h1>
        ...
        <div className="w-full my-10 md:flex justify-evenly">
          ...
          <div className="md:max-w-[30%] text-left">
            <div className="my-4 text-xl">
              Prices starting at{" "}
              <span className="font-bold">
                $249.99 for a monthly subscription
              </span>{" "}
            ...
            <ul className="ml-8 text-xl list-disc">
              ...
              <li className="my-5">
                A secure HIPPA comliant zoom that will guarentee that nobody
                will be able to access or hack the virtual sessions, and more.
              </li>
            </ul>
            <div className="text-xl">
              If you are interested or have any concerns, plase consult our
              contact page and we will get back with you as soon as possible.
            </div>
