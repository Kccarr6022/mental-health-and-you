        ...
        <div className="overflow-hidden">
            ...
            <div className="flex flex-col bg-primary-green pt-[3%]">
                <div className="flex justify-evenly w-full">
                    <span className="text-xl md:text-5xl text-slate-100 md:mb-5 font-bold md:font-normal">Public Profile</span>
                    <span className="text-xl md:text-5xl text-slate-100 md:mb-5 hidden md:block">Current Patients</span>
                </div>
                ...
                <div className="md:flex mx-[10%] text-lg">
                    <div className="flex flex-col md:max-w-[49.8%] mt-8 md:pl-[10%] items-center">
                    ...
                    <span className="text-lg md:text-5xl text-slate-100 md:mb-5 md:hidden font-bold md:font-normal w-full flex justify-center">Current Patients</span>
